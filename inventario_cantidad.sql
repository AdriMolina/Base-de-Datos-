...
CREATE TABLE `cantidad` (
  ...
  CONSTRAINT `cantidad_ibfk_1` FOREIGN KEY (`id_articulos`) REFERENCES `articulos` (`id_articulos`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `cantidad_ibfk_2` FOREIGN KEY (`id_departamento`) REFERENCES `departamentos` (`id_departamento`) ON DELETE CASCADE ON UPDATE CASCADE
